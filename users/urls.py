...
urlpatterns = [
    ...
    path('<username>/cleardata/<int:sran_level>/', views.cleardata, name='cleardata'),
    path('download/<file_type>/', views.download, name='download'),
    path('api/get_percentage_of_clear/<int:user_id>/', views.get_percentage_of_clear, name='get_percentage_of_clear'),
