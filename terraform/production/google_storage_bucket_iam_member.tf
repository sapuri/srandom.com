...
resource "google_storage_bucket_iam_member" "all_users_are_legacy_object_reader_of_static_srandom_com" {
  bucket = google_storage_bucket.static_srandom_com.name
  role   = "roles/storage.legacyObjectReader"
  member = "allUsers"
}
